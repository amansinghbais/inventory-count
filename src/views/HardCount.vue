    ...
    <ion-content class="main-content" ref="contentRef" :scroll-events="true" @ionScroll="enableScrolling()">
      <div class="header">
        <div class="search">
          ...
          <ion-segment scrollable v-model="selectedSegment" @ionChange="handleSegmentChange()">
...
async function saveCount() {
  ...
  if(dueDate.value) {
    count = { ...count, dueDate: dueDate.value }
  }

  let facilityIds = selectedFacilityIds.value;
